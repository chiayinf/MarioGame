...
public class WelcomeScreen2 implements Screen {
    ...
    public WelcomeScreen2(Game game){
        this.game = game;
        ...
        //texture = new Texture(Gdx.files.internal("mario2.jpeg"));
        ...
        table.add(introductionLabel).expandX();
        table.row();
